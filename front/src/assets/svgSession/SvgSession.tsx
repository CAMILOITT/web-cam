import css from './SvgSession.module.css'
interface IProps {}

export default function SvgSession({}: IProps) {
  return (
    <svg
      id="Capa_2"
      xmlns="http://www.w3.org/2000/svg"
      viewBox="0 0 67.15 33.63"
    >
      <defs>
        <clipPath id="clippath">
          <path
            className={css['cls-12']}
            d="M0,0H44.7V30.45c0,1.02-.83,1.85-1.85,1.85H1.85c-1.02,0-1.85-.83-1.85-1.85V0H0Z"
          />
        </clipPath>
      </defs>
      <g className={css['cls-13']}>
        <g>
          <rect
            className={css['cls-1']}
            x=".51"
          ...
          <path
            className={css['cls-3']}
            d="M2.44,4.4H42.26c1.07,0,1.93,.87,1.93,1.93v.95H.51v-.95c0-1.07,.87-1.93,1.93-1.93Z"
          />
        </g>
        <g>
          <g>
            <path
              className={css['cls-10']}
            ...
            <g>
              <g>
                ...
                <path
                  className={css['cls-7']}
                  d="M28.72,16.58c0,.63-1.17,.46-1.17,.46,0,0,.78,0,.78,.43"
                />
              </g>
              <g>
                <circle
                ...
                <path
                  className={css['cls-6']}
                  d="M11.82,16.58c0,.63,1.17,.46,1.17,.46,0,0-.78,0-.78,.43"
                />
              </g>
              <g>
                <rect
                ...
                <g>
                  <path
                    className={css['cls-11']}
                    d="M18.84,19.57s.36,.87,1.5,.87c1.05,0,1.37-.87,1.37-.87"
                  />
                  <g>
          ...
          <g>
            <g>
              ...
              <path
                className={css['cls-4']}
                d="M28.96,22.44h4.48v6.25h-4.48c-1.73,0-3.13-1.4-3.13-3.13h0c0-1.73,1.4-3.13,3.13-3.13Z"
                transform="translate(-9.4 28.45) rotate(-45)"
              />
            </g>
            <circle className={css['cls-8']} cx="35.54" cy="9.33" r="2.25" />
          </g>
          <g>
            <path
              className={css['cls-8']}
            ...
            <path
              className={css['cls-4']}
              d="M11.16,24.98h4.48v6.25h-4.48c-1.73,0-3.13-1.4-3.13-3.13h0c0-1.73,1.4-3.13,3.13-3.13Z"
